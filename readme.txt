...
Installing "bluem-woocommerce" can be done either by searching for "bluem-woocommerce" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
