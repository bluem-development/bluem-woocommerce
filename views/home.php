...
<div class="wrap">
    ...
    <p><strong>Technische gegevens</strong><br />WordPress versie: <?php echo get_bloginfo('version'); ?><br />WooCommerce versie: <?php echo class_exists('WooCommerce') ? WC()->version : __('WooCommerce niet geinstalleerd.', 'bluem-woocommerce'); ?><br />PHP versie: <?php echo phpversion(); ?></p>
