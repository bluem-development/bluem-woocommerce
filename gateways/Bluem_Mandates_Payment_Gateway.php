...
class Bluem_Mandates_Payment_Gateway extends Bluem_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_description = 'eMandate Payment Gateway voor WordPress - WooCommerce. Alle instellingen zijn in te stellen onder <a href="' . admin_url( 'options-general.php?page=bluem' ) . '">Instellingen &rarr; Bluem</a>';
	...
	public function process_payment( $order_id ) {
		...
		$this->bluem = new \Bluem\BluemPHP\Bluem( $this->bluem_config );
